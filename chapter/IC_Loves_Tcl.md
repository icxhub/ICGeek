...
有些编程语言本身单独看起来并没有优势，脱离开应用场景后甚至可以说是一门即将被淘汰的语言，这一篇我们来看看Tcl （我认为单独来看一点优势也没有）没有被淘汰的原因有哪些。
...
<span style="color:blue;font-weight:600">从图中我们可以了解到有个概念很重要，你输入到Tcl的所有交互的指令或者其他接口都被认为是文本，按一定的顺序进行parser。</span>
